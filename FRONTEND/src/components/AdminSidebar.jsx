...
const navItems = [
  ...
  { path: '/admin/dashboard/students', icon: Users, label: 'Manage Students' },
  { path: '/admin/dashboard/events', icon: Calendar, label: 'Manage Events' },
  { path: '/admin/dashboard/ideas', icon: Lightbulb, label: 'Innovation Ideas' },
  { path: '/admin/dashboard/projects', icon: FolderKanban, label: 'Project Submissions' },
  { path: '/admin/dashboard/hackathons', icon: Trophy, label: 'Hackathon Submissions' },
  { path: '/admin/dashboard/mentorship', icon: MessageCircle, label: 'Mentorship Requests' },
  { path: '/admin/dashboard/resources', icon: BookOpen, label: 'Learning Resources' },
  { path: '/admin/dashboard/notifications', icon: Bell, label: 'Notifications' },
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${
                  isActive
                    ...
                    : 'text-slate-400 hover:bg-white/5 hover:text-white hover:border-[#22d3ee]/20'
                }`
              }
            >
